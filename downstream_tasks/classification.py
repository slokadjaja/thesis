...
def run_experiment(
    ...
    # Train random forest using encodings
    results = []
    for i in range(iters_per_setting):
        results.append(
            random_forest_classifier(X_train_emb, y_train, X_test_emb, y_test)
        )
...
def classification(
    ...
    generated by SAX and VAEs. It trains a random forest classifier on these representations and computes metrics such
...
if __name__ == "__main__":
    ...
    sax_params = [{"n_segments": 16, "alphabet_size": 32}]
    n_iters = 10
